...
var description = new TextBundle()
    .add('en', 'Please review the data below and confirm whether you would like to donate it. Carefully check the data and adjust when required. The research project is only interested in organizations. Therefore, we recommend you to: (1) Click on adjust; (2) Select all content that is not related to organizations (e.g., companies, public institutions, governments etc.); (3) Click on delete. By doing this, you are removing content from others who may not be relevant for this study. Your donation will help us understand ow individuals react to posts disseminated by organizations, i.e., whether they like posts, share them, or comment on them. Thank you in advance!')
